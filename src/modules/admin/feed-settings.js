...
export const FEED_SETTING_DEFS = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        label: "Style",
        hint: "Compact matches KA0SB0T-style embeds",
        default: "compact",
        options: [
          { value: "compact", label: "Compact (Victim 💀 Killer)" },
      ...
      },
      {
        ...
        type: "text",
        label: "Death icon",
        hint: "Between victim and killer",
        default: "💀",
        placeholder: "💀",
      },
      {
        ...
        type: "text",
        label: "Hit icon",
        hint: "Shown after killer (and with distance when available)",
        default: "🎯",
        placeholder: "🎯",
      },
    ],
