...
export const WIPE_STEPS = [
  {
    id: "resetStats",
    label: "Reset wipe stats & leaderboard data",
    hint: "Clears kills / deaths / playtime tracking for a new wipe label",
    defaultOn: true,
  },
  {
    id: "clearHomes",
    label: "Clear player homes",
    hint: "Deletes all /home set locations (warps kept)",
    defaultOn: true,
  },
  {
    id: "clearTpCooldowns",
    label: "Clear teleport cooldowns",
    hint: "Resets home / warp / TPR cooldowns in the bot",
    defaultOn: true,
  },
  {
    id: "clearKitCooldowns",
    label: "Reset kit cooldowns (RCON)",
    hint: "Tries KitManager reset commands on the game server",
    defaultOn: true,
  },
  {
    id: "clearStreaks",
    label: "Clear kill streaks",
    hint: "Resets in-memory killfeed streak counters",
    defaultOn: true,
  },
  {
    id: "clearGroupAlerts",
    label: "Clear group-limit alert cooldowns",
    hint: "Lets trio alerts fire fresh after wipe",
    defaultOn: true,
  },
  {
    id: "resetAnalytics",
    label: "Reset weapon analytics",
    hint: "Clears top-weapon kill counters for the new wipe",
    defaultOn: false,
  },
  {
    id: "publishLeaderboard",
    label: "Refresh Discord + website leaderboard",
    hint: "Edits the live leaderboard image (empty boards until new kills)",
    defaultOn: true,
  },
  {
    id: "clearWipeCountdown",
    label: "Clear wipe countdown channel",
    hint: "Sets wipe time to empty so status shows TBA / Wiped",
    defaultOn: true,
  },
  {
    id: "announce",
    label: "Announce wipe in Discord + in-game",
    hint: "Posts to CHANNEL_WIPES and says in-game",
    defaultOn: true,
  },
];
